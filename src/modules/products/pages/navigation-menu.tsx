...
export default function NavigationMenu({
  ...
  return (
    <header className='fixed z-30 w-full md:top-6'>
      <div className='mx-auto max-w-5xl px-4 sm:px-6'>
        <div className='flex h-14 w-full items-center justify-between gap-3 rounded-full border border-gray-100 bg-white px-3 shadow-lg shadow-black/4'>
          ...
          <div className='flex flex-1 items-center justify-end'>
            <a
              className='inline-flex justify-center rounded-full bg-indigo-500 px-3 py-1.5 text-sm font-medium whitespace-nowrap text-white shadow transition-colors hover:bg-indigo-600 focus-visible:ring focus-visible:ring-indigo-300 focus-visible:outline-none'
              href='#0'
            >
              Sign up
            </a>
